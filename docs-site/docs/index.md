...
hero:
  name: Burger Barn
  text: Learn HTML & CSS by Building
  tagline: Build a restaurant menu webpage from scratch — one concept at a time
  actions:
    - theme: brand
      text: Get Started
      link: /overview
    - theme: alt
      text: GitHub
      link: https://github.com/vedanta/burger-barn
---

<div class="vp-doc" style="max-width: 900px; margin: 0 auto; padding: 2rem;">
...
```mermaid
graph LR
    A[HTML Skeleton] --> B[Header & Intro]
    B --> C[Semantic Sections]
    C --> D[Menu Items]
    D --> E[Footer]
    E --> F[Basic CSS]
    F --> G[Spacing]
